...
<head>
    ...
    <style>
        ...
        ::-webkit-scrollbar-thumb { background: #e6e6db; border-radius: 4px; }
        ::-webkit-scrollbar-thumb:hover { background: #8c8b5f; }
...
<section class="px-4 py-6 md:px-10 lg:px-20 xl:px-40">
    <div class="flex flex-col gap-6 bg-cover bg-center bg-no-repeat rounded-xl md:rounded-[3rem] items-center justify-center p-8 md:p-20 min-h-[500px] shadow-sm relative overflow-hidden group" style='background-image: url("https://images.unsplash.com/photo-1497215728101-856f4ea42174?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80");'>
        ...
        <div class="relative z-10 flex flex-col gap-4 text-center max-w-3xl">
            <h1 class="text-white text-4xl md:text-6xl font-black leading-tight tracking-[-0.033em]">Trouvez le job qui vous correspond</h1>
            <p class="text-white/90 text-lg font-medium leading-normal max-w-2xl mx-auto">Des milliers d'offres d'emploi, de stages et d'alternances mises à jour quotidiennement pour propulser votre carrière.</p>
        </div>
        <div class="relative z-10 w-full max-w-2xl mt-4">
            <form action="search" method="GET" class="flex flex-col md:flex-row w-full bg-white rounded-xl md:rounded-full p-2 gap-2 shadow-lg">
    ...
    <div class="max-w-[1200px] mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="group flex flex-col items-stretch justify-start rounded-xl overflow-hidden bg-surface-light dark:bg-surface-dark shadow-sm hover:shadow-md transition-shadow border border-[#e6e6db] dark:border-white/5">
                <div class="w-full h-48 bg-center bg-no-repeat bg-cover group-hover:scale-105 transition-transform duration-500" style='background-image: url("https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80");'></div>
                <div class="flex w-full grow flex-col items-stretch justify-center gap-4 p-6">
                    ...
                    <div class="mt-auto pt-2">
                        <a href="register.jsp?role=candidat" class="flex w-full md:w-auto cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-6 bg-primary hover:bg-yellow-300 transition-colors text-[#181811] text-sm font-bold leading-normal">
            ...
            <div class="group flex flex-col items-stretch justify-start rounded-xl overflow-hidden bg-surface-light dark:bg-surface-dark shadow-sm hover:shadow-md transition-shadow border border-[#e6e6db] dark:border-white/5">
                <div class="w-full h-48 bg-center bg-no-repeat bg-cover group-hover:scale-105 transition-transform duration-500" style='background-image: url("https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80");'></div>
                <div class="flex w-full grow flex-col items-stretch justify-center gap-4 p-6">
                    <div>
                    ...
                    <div class="mt-auto pt-2">
                        <a href="register.jsp?role=recruteur" class="flex w-full md:w-auto cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-6 bg-surface-light dark:bg-white/10 border border-[#e6e6db] dark:border-white/10 hover:border-primary hover:bg-background-light dark:hover:bg-white/20 transition-colors text-text-main dark:text-white text-sm font-bold leading-normal">
...
<section class="px-4 py-10 md:px-10 lg:px-20 xl:px-40 bg-white dark:bg-white/5">
    <div class="max-w-[1200px] mx-auto">
        <div class="flex justify-between items-end mb-8">
            ...
            <a class="hidden md:inline-flex items-center gap-1 text-sm font-bold text-text-main dark:text-white underline decoration-primary decoration-2 underline-offset-4 hover:decoration-4 transition-all" href="login.jsp">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="bg-background-light dark:bg-background-dark p-6 rounded-lg hover:shadow-lg transition-all duration-300 border border-transparent hover:border-primary/50 group cursor-pointer flex flex-col h-full">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <span class="bg-white dark:bg-white/10 text-xs font-bold px-3 py-1 rounded-full text-text-main dark:text-white">Freelance</span>
                </div>
                <h3 class="text-lg font-bold text-text-main dark:text-white mb-1 group-hover:text-primary transition-colors">Frontend Developer</h3>
                <p class="text-text-muted text-sm mb-4">Airbnb • Full Remote</p>
                <div class="mt-4 pt-4 border-t border-black/5 dark:border-white/10 flex justify-between items-center text-xs font-medium text-text-muted">
                    <span>Il y a 5h</span>
                    <span class="text-text-main dark:text-white group-hover:underline">Postuler</span>
                </div>
...
<footer class="bg-surface-light dark:bg-surface-dark py-12 px-4 md:px-10 lg:px-20 border-t border-[#e6e6db] dark:border-white/5">
    <div class="max-w-[1200px] mx-auto text-center">
        <p class="text-text-muted text-sm">© 2025 JobBoard Inc.</p>
    </div>
</footer>
</div>
</body>
