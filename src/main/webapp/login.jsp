                ...
                <% } %>
                    ...
                    <% if ("success".equals(request.getParameter("registered"))) { %>
                        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4"
                            role="alert">
                            <span class="block sm:inline">Inscription réussie ! Vous pouvez maintenant vous
                                connecter.</span>
                        </div>
                        <% } %>
                            ...
                            <p class="mt-4 text-center text-sm text-gray-500">
                                Pas encore de compte ? <a href="register.jsp"
                                    class="text-black font-bold hover:underline">Inscrivez-vous</a>
                            </p>
