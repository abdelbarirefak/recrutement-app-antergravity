                ...
                <div class="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Liste et gestion des comptes recruteurs</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <% List<User> enterprises = (List<User>) request.getAttribute("enterprises"); %>
                        ...
                        <% if (enterprises==null || enterprises.isEmpty()) { %>
                            <div class="bg-white rounded-2xl shadow-sm p-12 text-center">
                                ...
                                <h3 class="text-xl font-bold text-slate-900 mb-2">Aucune entreprise inscrite</h3>
                                <p class="text-slate-500">Les entreprises apparaîtront ici une fois inscrites.</p>
                            </div>
                            <% } else { %>
                                <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                                    <div
                                        class="p-5 bg-indigo-50 border-b border-indigo-200 flex justify-between items-center">
                                        <p class="text-indigo-800 font-semibold">
                                            <%= enterprises.size() %> entreprise(s)
                                        </p>
                                    </div>
                                    <table class="w-full">
                                                ...
                                                <tr class="hover:bg-slate-50">
                                                    ...
                                                    <td class="p-4 text-right">
                                                        <form action="admin/entreprises" method="POST"
                                                            ...
                                                            onsubmit="return confirm('Supprimer cette entreprise et son compte ?');">
