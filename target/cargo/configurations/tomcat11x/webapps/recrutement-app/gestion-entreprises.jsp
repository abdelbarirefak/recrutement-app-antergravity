<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page
        import="java.util.List, com.recrutement.entity.User, com.recrutement.entity.Enterprise, com.recrutement.entity.JobOffer, com.recrutement.entity.RegistrationRequest"
        %>
        <!DOCTYPE html>
        <html lang="fr">
        ...
        <head>
            <meta charset="utf-8" />
            <title>Gestion des Entreprises - Administration</title>
        ...
        <body class="bg-slate-50 min-h-screen">
                ...
                <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-xl font-bold text-slate-900">Gestion des Entreprises</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-6 py-8 space-y-8">
                ...
                <% List<RegistrationRequest> pendingRequests = (List<RegistrationRequest>)
                        request.getAttribute("pendingEnterprises"); %>
                                ...
                                <% if(pendingRequests !=null && !pendingRequests.isEmpty()) { for(RegistrationRequest
                                    ...
                                    <div class="p-5 flex items-center justify-between hover:bg-slate-50">
                                        ...
                                        <div class="flex gap-2">
                                            <form action="admin/entreprises" method="POST" style="display:inline">
                        ...
                        <% List<User> enterprises = (List<User>) request.getAttribute("enterprises"); %>
                                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                                    <div
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <h2 class="font-bold text-slate-800">Entreprises Actives</h2>
                                        </div>
                                        <span
                                            class="bg-indigo-100 text-indigo-800 text-xs font-bold px-3 py-1 rounded-full">
                                            <%= enterprises !=null ? enterprises.size() : 0 %>
                                        </span>
                                    </div>
                                    <table class="w-full text-left text-sm">
                                        ...
                                        <tbody class="divide-y divide-slate-100">
                                            <% if(enterprises !=null) { for(User u : enterprises) { %>
                                                <tr class="hover:bg-slate-50">
                                                    ...
                                                    <td class="p-4 text-right">
                                                        <form action="admin/entreprises" method="POST"
